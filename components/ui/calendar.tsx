  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[selected=true]:bg-[#F2D578]! data-[selected=true]:text-black! data-[selected=true]:font-bold",
        "data-[has-slots=true]:bg-[#F2D578]! data-[has-slots=true]:text-black! data-[has-slots=true]:font-bold",
