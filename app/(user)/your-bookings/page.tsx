...
export default function YourBookingsPage() {
  ...
  const renderBookingCard = (booking: (typeof bookings)[0], index: number) => {
            ...
            <div className="mt-6">
              {upcomingBookings.length === 0 ? (
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-1">
                  {upcomingBookings.map((booking, index) => renderBookingCard(booking, index))}
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === "past" && (
            <div className="mt-6">
              {pastBookings.length === 0 ? (
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-1">
                  {pastBookings.map((booking, index) => renderBookingCard(booking, index))}
                </div>
              )}
            </div>
          )}
